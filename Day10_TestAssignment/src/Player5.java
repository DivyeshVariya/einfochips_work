...
public class Player5 {
	...
	public Player5(String name, LocalDate date, String skill, int numberOfMatches, int runs, int wickets,
	...
	public static Player5 createPlayer(String detail) {
		...
		return new Player5(name, LocalDate.parse(dateOfBirth), skill, numberOfMatches, runs, wickets, nationality, powerRating);
	}
	@Override
	...
	static Map<String, Integer> calculateNationalityCount(  List<Player5> list) 
	{
		Set<String> countries = new TreeSet<String>();
		Map<String,Integer> map=new TreeMap<String,Integer>();
		Collections.sort(list,(p,q)->p.getNationality().compareTo(q.getNationality()));
		for(Player5 player:list)
	...
	public static String highestCount(List<Player5> playerList) 
	{
